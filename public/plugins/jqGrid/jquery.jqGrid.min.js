...
!function (a) {
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                $(d).before(e.hDiv).click(function (a) {
                    ...
                    if ("A" !== fb.tagName && ("INPUT" !== fb.tagName && "TEXTAREA" !== fb.tagName && "OPTION" !== fb.tagName && "SELECT" !== fb.tagName || b))if (yb = gb[0].id, fb = $(fb).closest("tr.jqgrow>td"), fb.length > 0 && (zb = $.jgrid.getCellIndex(fb), Ab = $(fb).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [yb, zb, Ab, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, yb, zb, Ab, a)), d.p.cellEdit !== !0) {
                    ...
                    } else if (d.p.multiselect && b && c)$(d).jqGrid("setSelection", yb, !0, a); else if (fb.length > 0)try {
                        $(d).jqGrid("editCell", gb[0].rowIndex, zb, !0)
                    } catch (g) {
                    }
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.cellEdit === !0) {
                    if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
                        var g, h, i = $("td:eq(" + b + ")", d.rows[a]), j = d.p.colModel[b], k = j.name, l = $.jgrid.jqID(k), m = $(i).offset();
                        switch (j.edittype) {
                            case"select":
                        ...
                        if (h !== d.p.savedRow[c].v) {
                            ...
                            if (t[0] === !0) {
                                var u = $(d).triggerHandler("jqGridBeforeSubmitCell", [d.rows[a].id, k, g, a, b]) || {};
                                if ($.isFunction(d.p.beforeSubmitCell) && (u = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), u || (u = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)if (d.p.cellurl) {
                                    var v = {};
                                    d.p.autoencode && (g = $.jgrid.htmlEncode(g)), v[k] = g;
                                    var w, x, y;
                                    y = d.p.prmNames, w = y.id, x = y.oper, v[w] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id), v[x] = y.editoper, v = $.extend(u, v), $(d).jqGrid("progressBar", {
                                        method: "show",
                                        loadtype: d.p.loadui,
                                        htmlcontent: $.jgrid.getRegional(d, "defaults.savetext")
                                    }), d.grid.hDiv.loading = !0, $.ajax($.extend({
                                        url: d.p.cellurl,
                                        data: $.isFunction(d.p.serializeCellData) ? d.p.serializeCellData.call(d, v) : v,
                                        type: "POST",
            ...
            return a = $.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    a.restoreFromFilters && (f = c.p.postData.filters, f && ("string" == typeof f && (f = $.jgrid.parse(f)), e = f.rules.length ? f.rules : !1)), $.each(c.p.colModel, function (b) {
                        ...
                        if (this.hidden === !0 && $(u).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), f = $.extend({}, this.searchoptions || {}, {
                                name: r.index || r.name,
    ...
    if ($.jgrid.extend({
            editGridRow: function (a, b) {
                ...
                return this.each(function () {
                    var i = this, j = $.jgrid.getRegional(i, "nav"), k = i.p.styleUI, l = ($.jgrid.styleUI[k].navigator, $.jgrid.styleUI[k].filter), m = $.jgrid.styleUI[k].common, n = "form_menu_" + $.jgrid.randId(), o = c.navButtonText ? c.navButtonText : j.selectcaption || "Actions", p = "<button class='dropdownmenu " + m.button + "' value='" + n + "'>" + o + "</button>";
                    ...
                    var q = {
                        ...
                        var a, j, k = $(".ui-jqgrid-view").css("font-size") || "11px", o = $('<ul id="' + n + '" class="ui-nav-menu modal-content" role="menu" tabindex="0" style="display:none;font-size:' + k + '"></ul>');
            ...
            saveState: function (a, b) {
                ...
                if (c = $.extend(c, b || {}), c.regional) {
                    ...
                    var d = $("#" + a)[0], e = $(d).jqGrid("getGridParam", "colModel"), f = -1, g = $.jgrid.getRegional(d, "nav");
                    $.each(e, function (a) {
    ...
    $.jgrid.extend({
        ...
        pivotSetup: function (a, b) {
                ...
                function m(a, b, c, d) {
                    ...
                    for ($.isArray(c) ? (j = c.length, n = c) : (j = 1, n[0] = c), f = [], g = [], f.root = 0, d._count ? d._count++ : d._count = 1, i = 0; j > i; i++) {
                        ...
                        for (e = 0; k > e; e++) {
                            ...
                            h = isNaN(parseInt(h, 10)) ? h : h + " ", d[h] = p[h] = l(b[e].aggregator, d[h], b[e].member, a, d._count), 1 >= i && "_r_Totals" !== o && "" === m && (m = o)
                        }
                        f[h] = p, g[h] = n[i]
                    }
                    return d
            ...
            return this.each(function () {
                function e(a) {
                    var d, e, g, h, i = jQuery(f).jqGrid("pivotSetup", a, b), j = $.assocArraySize(i.summary) > 0 ? !0 : !1, k = $.jgrid.from.call(f, i.rows);
